...
public class ProfileAddress extends javax.swing.JFrame {

    /**
     * Creates new form ProfileAddress
     */
    int id;
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try
        {
            ...
            String sql="UPDATE userinfo SET address='"+jTextField.getText()+"' where accountno="+id;
            ...
            if(i>0)
            {
                JOptionPane.showMessageDialog(null,"New Address Updated");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfileAddress.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfileAddress().setVisible(true);
            }
        });
    }
