...
public class ProfileBirth extends javax.swing.JFrame {

    /**
     * Creates new form ProfileBirth
     */
    int id;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Date Of Birth");
        ...
        jLabel2.setText("Enter New Date Of Birth");

        jTextField.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextField.setText("dd/mm/yy");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try
        {
            ...
            String sql="UPDATE userinfo SET dob='"+jTextField.getText()+"' where accountno="+id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfileBirth.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfileBirth().setVisible(true);
            }
        });
    }
